...
if ($_REQUEST['action'] == "changecore") {
	...
	$options .= '<li><input name="page_2" type="checkbox" value="ON" checked /> Change the default page name from "Sample Page" to: <input name="about_page" size="15" type="textbox" value="Home" /></li>';
} 
...
if ($_REQUEST['action'] == "changecore") {
	...
	$options .= '<li><input name="set_home" type="checkbox" value="ON" checked /> Set the default page above as the front page.</li>';
} 
