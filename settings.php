...
<h3><span><img src="<?php echo plugins_url(); ?>/seo-automatic-wp-core-tweaks/images/favicon.ico" alt="Search Commander Inc." /> Core Tweaks Admin</span></h3>
<div class="inside">
<?php
...
//Set category names
//REMOVED BLOGROLL CATEGORY NAME OPTION, BUT INCLUDED HIDDEN TO ALLOW IMPORT TO CONTINUE WORKING
include('cat-names.php');

//Uncheck organize by month/year
include('org-uploads.php');

//Turn off thumnail cropping
include('img-crop.php');
...
//REMOVED PER REQUIRED SECURITY ISSUE BY WORDPRESS.ORG
...
<p>The steps and actions on this page are primarily used for a brand new WP setup, and are based on an employee checklist from <a href="https://www.searchcommander.com/wp-core-tweaks/" target="_blank" rel="nofollow">Search Commander, Inc.</a></p>
<p>This plugin is designed to compliment, <strong>not replace</strong>, either the "<a href="https://wordpress.org/plugins/wordpress-seo/" target="_blank" rel="nofollow">Yoast Wordpress SEO</a>" plugin or the "<a href="http://wordpress.org/extend/plugins/all-in-one-seo-pack/" target="_blank" rel="nofollow">All in One SEO pack</a>", or any other SEO plugin.</p>
<p>This plugin completes tasks that they do not, and there is no conflict.</p>
<p>You should have no other plugins active while running the SEO Tools Core Tweaks process. To see a short video of how to use this plugin, <a href="https://www.searchcommander.com/wp-core-tweaks/" target="_blank">click here</a> and if you need support, please send an email by clicking <a href="mailto:scott@searchcommander.com?cc=heather@searchcommander.com&subject=Core%20Tweaks%20Support">here</a>.</p>
<p>
<b>READ ME FIRST:</b>
...
<p>If you don't understand what this means, <a href="mailto:scott@searchcommander.com?Subject=Core%20Tweaks%20Installation%20Question">please report it...</a></p>
</div></div>
